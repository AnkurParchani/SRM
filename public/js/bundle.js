...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../utils/helperFunction.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeEntriesClasses = void 0;

/* eslint-disable */
var removeEntriesClasses = function removeEntriesClasses(Array) {
  Array.forEach(function (row) {
    row.classList.remove("rowClicked");
  });
};

exports.removeEntriesClasses = removeEntriesClasses;
...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/js-cookie/dist/js.cookie.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var showAlert = function showAlert(type, message, time) {
  hideAlert();
  var html = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
...
exports.addEntry = exports.addCustomer = void 0;
...
_axios.default.defaults.headers.common["Authorization"] = "Bearer ".concat(_jsCookie.default.get("jwt"));
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(name, area, phoneNumber, firmName) {
    var data, res;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Customer created", 1.5);
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
        ...
        case 9:
          ...
          (0, _alerts.showAlert)("error", _context.t0.response.data.message, 3);
  ...
  return function addCustomer(_x, _x2, _x3, _x4) {
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee2(data) {
    var currentCustomerId, form, i, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          // Getting the current customer's id
          currentCustomerId = window.location.pathname.split("/")[2]; // Making the form object to send over axios
          ...
          form.append("creditBalance", data.creditAmount); // Sending all images of documents
        ...
        case 11:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Entry created", 1);
            setTimeout(function () {
              location.assign("/customers/".concat(currentCustomerId));
            }, 1000);
        ...
        case 15:
          ...
          (0, _alerts.showAlert)("error", _context2.t0.response.data.message, 3);
  ...
  return function addEntry(_x5) {
    return _ref2.apply(this, arguments);
  };
}();

exports.addEntry = addEntry;
},{"axios":"../../node_modules/axios/index.js","js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js","./alerts":"alerts.js"}],"helperFunctions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.enableLinks = exports.disableLinks = void 0;

/* eslint-disable */
var disableLinks = function disableLinks(links) {
  links.forEach(function (link) {
    document.querySelector("#".concat(link)).classList.add("disabled");
  });
};

exports.disableLinks = disableLinks;

var enableLinks = function enableLinks(links) {
  links.forEach(function (link) {
    document.querySelector("#".concat(link)).classList.remove("disabled");
  });
};

exports.enableLinks = enableLinks;
...
exports.deleteEntry = exports.deleteCustomer = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(currentCustomerId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "http://127.0.0.1:5000/api/v1/customers/".concat(currentCustomerId)
          });
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Customer Deleted successfully", 2);
            setTimeout(function () {
  ...
  return function deleteCustomer(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(rowId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "http://127.0.0.1:5000/api/v1/ledgerEntries/".concat(rowId)
          });
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Entry deleted successfully", 1);
            setTimeout(function () {
              location.reload();
            }, 1000);
          }
  ...
  return function deleteEntry(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteEntry = deleteEntry;
},{"axios":"../../node_modules/axios/index.js","js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js","./alerts":"alerts.js"}],"login.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            ...
            _jsCookie.default.set("jwt", res.data.token, {
              expires: expirationTime,
              path: "/"
            });

            (0, _alerts.showAlert)("success", "Logged in! welcome", 1.5);
            setTimeout(function () {
              location.assign("/customers");
            }, 1500);
          }
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", _context.t0.response.data.message, 2);
...
var logout = function logout() {
  if (_jsCookie.default.get("jwt")) _jsCookie.default.remove("jwt");
  (0, _alerts.showAlert)("success", "Logged out successfully", 2);
  setTimeout(function () {
    location.assign("/");
  }, 2000);
};
...
},{"axios":"../../node_modules/axios/index.js","js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js","./alerts":"alerts.js"}],"modal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showModal = exports.showDocumentsModal = void 0;
...
var showModal = function showModal(modalName) {
  ...
  function getModal(modalClass) {
    modalForm.forEach(function (forms, i) {
      var currentModal = document.querySelector(".".concat(modalClass));
...
var showDocumentsModal = function showDocumentsModal() {
  var documentContainer = document.querySelector(".showDocuments");
  var modalBackdrop = document.querySelector(".modalBackdrop");
  ...
  function closeModal() {
    ...
    document.querySelector(".showDocuments").insertAdjacentHTML("beforeend", "<div class='owl-carousel owl-theme'>\n         </div>");
    documentContainer.style.display = "none";
    modalBackdrop.style.display = "none";
  }

  document.querySelector(".closeDocModalBtn").addEventListener("click", closeModal);
  modalBackdrop.addEventListener("click", closeModal);
};

exports.showDocumentsModal = showDocumentsModal;
},{"./alerts":"alerts.js"}],"search.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ledgerSearch = exports.customerSearch = void 0;
...
function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (area) {
            url += "area=".concat(area, "&");
          }

          if (phoneNumber) {
            url += "phoneNumber=".concat(phoneNumber, "&");
          }

          if (firmName) {
            url += "firmName=".concat(firmName, "&");
  ...
  return function customerSearch(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(particulars, date, debitAmount, creditAmount) {
    var currentCustomerId, url, currentCookie;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          currentCustomerId = window.location.pathname.split("/")[2];
          url = "/customers/".concat(currentCustomerId, "?");
          if (particulars) url += "particulars=".concat(particulars.toLowerCase(), "&");
          if (date) url += "searchDate=".concat(date, "&");
          if (debitAmount) url += "debitBalance=".concat(debitAmount, "&");
          if (creditAmount) url += "creditBalance=".concat(creditAmount, "&"); //   // If there's a '&' at the end of the url then replace it

          url = url.replace(/&$/, ""); // Will have to see this tomorrow

          _jsCookie.default.set("jwt", currentCookie, {
            path: "".concat(url)
          });

          currentCookie = _jsCookie.default.get("jwt");
          location.assign(url);
  ...
  return function ledgerSearch(_x5, _x6, _x7, _x8) {
    return _ref2.apply(this, arguments);
  };
}();

exports.ledgerSearch = ledgerSearch;
},{"axios":"../../node_modules/axios/index.js","js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js"}],"update.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateEntry = exports.updateCustomer = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(data, entryId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "http://127.0.0.1:5000/api/v1/ledgerEntries/".concat(entryId),
            data: data
          });
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Entry updated", 1.5);
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          console.log("Axios updateEntry error", _context.t0);
  ...
  return function updateEntry(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(currentCustomerId, name, area, firmName, phoneNumber) {
    var data, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 8:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Customer Updated Successfully", 1.5);
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
        ...
        case 12:
          _context2.prev = 12;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)("error", err.response.data.message, 3);
  ...
  return function updateCustomer(_x3, _x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateCustomer = updateCustomer;
},{"axios":"../../node_modules/axios/index.js","js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js","./alerts":"alerts.js"}],"documents.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showDocuments = exports.addDocuments = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(entryId) {
    var res, photos, _iterator, _step, _loop;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _axios.default)("http://127.0.0.1:5000/api/v1/ledgerEntries/".concat(entryId));
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  img.src = "/img/documents/".concat(photo);
                  _context.next = 6;
                  return loaded;

                case 6:
                  html = "<img src=".concat(img.src, " class=\"img-fluid docImage\" alt=\"Image not found\"/>");
                  document.querySelector(".owl-carousel").insertAdjacentHTML("beforeend", html);
        ...
        case 22:
          ...
          (0, _modal.showDocumentsModal)();
          _context2.next = 27;
          break;

        case 26:
          (0, _alerts.showAlert)("error", "No documents found with this entry", 2);
        ...
        case 29:
          ...
          console.log("Axios show Documents error", _context2.t2);

        case 32:
        case "end":
          return _context2.stop();
      }
    }, _callee, null, [[0, 29], [7, 16, 19, 22]]);
  }));

  return function showDocuments(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(images, entryId) {
    var customerId, imageForm, i, res;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            data: imageForm,
            url: "http://127.0.0.1:5000/api/v1/ledgerEntries/".concat(entryId, "/addDocs")
          });
        ...
        case 6:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Document added Successfully", 1.5);
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function addDocuments(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.addDocuments = addDocuments;
},{"axios":"../../node_modules/axios/index.js","./modal":"modal.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var noCustomersPage = document.querySelector(".noCustomersPage");
var unauthorizedPage = document.querySelector(".unauthorizedPage");
var customerTableTr = document.querySelectorAll(".customerTable_tr");
var entrySearchForm = document.querySelector(".entrySearchForm");
var customerSearchForm = document.querySelector(".customerSearchForm");
var addCustomerForm = document.querySelector(".customerAddForm");
var addEntryForm = document.querySelector(".addEntryForm");
var entryTableTr = document.querySelectorAll(".entryTable_tr");
var updateCustomerForm = document.querySelector(".updateCustomerForm");
var addDocs = document.querySelector(".addDocs"); // For login

if (loginForm) {
  // Disabling nav links
  (0, _helperFunctions.disableLinks)(["addCustomerLink", "allCustomerLink", "logoutBtn"]);
...
if (noCustomersPage) {
  (0, _helperFunctions.disableLinks)(["allCustomerLink"]);
  document.querySelector("#addCustomerLink").addEventListener("click", function () {
    console.log("clicked on add customer");
    (0, _modal.showModal)("addCustomer");
  });
  document.querySelector(".noCustomersContainer_addCustomer").addEventListener("click", function () {
    console.log("clicked on add customer");
    (0, _modal.showModal)("addCustomer");
  });
}

if (unauthorizedPage) (0, _helperFunctions.disableLinks)(["addCustomerLink", "allCustomerLink", "logoutBtn"]);

if (customerTableTr) {
  // Looping through all rows
  customerTableTr.forEach(function (row) {
    row.addEventListener("click", function (e) {
      var selectedCustomerId = row.dataset.id; // Locating customer to it's particular page if the click is not of EDIT button

      if (!e.target.closest(".dropdown_td")) {
        return location.assign("customers/".concat(selectedCustomerId));
      } // If user selected for deleting customer


      if (e.target.closest(".deleteCustomerBtn")) {
        // Getting all the delete customer's variables
        var deleteCustomerModal = document.querySelector(".deleteCustomer-modal");
        var confirmDelete = document.querySelector(".deleteCustomerModal_deleteBtn");
        var cancelBtn = document.querySelector(".deleteCustomer-modal_closeBtn");
        var modalBackdrop = document.querySelector(".modalBackdrop"); // Showing the modal
        ...
        confirmDelete.addEventListener("click", function () {
          ...
          (0, _delete.deleteCustomer)(selectedCustomerId);
        });
      ...
      if (e.target.closest(".updateCustomerBtn")) {
        (0, _modal.showModal)("updateCustomer");
        updateCustomerForm.addEventListener("submit", function (e) {
          e.preventDefault();
          var name = document.querySelector("#updateCustomer-name").value.trim();
          var area = document.querySelector("#updateCustomer-area").value.trim();
          var phoneNumber = document.querySelector("#updateCustomer-phoneNumber").value.trim();
          var firmName = document.querySelector("#updateCustomer-firmName").value.trim();
          (0, _update.updateCustomer)(selectedCustomerId, name, area, firmName, phoneNumber);
        });
      }
    });
  });
...
if (addCustomerForm) {
  ...
  addCustomerForm.addEventListener("submit", function (e) {
    e.preventDefault(); // Getting all the data

    var name = document.querySelector("#customerAdd-name").value.trim();
    var area = document.querySelector("#customerAdd-area").value.trim();
    var phoneNumber = document.querySelector("#customerAdd-phoneNumber").value.trim();
    var firmName = document.querySelector("#customerAdd-firmName").value.trim(); // Sending the data to make request

    (0, _add.addCustomer)(name, area, phoneNumber, firmName);
  });
...
if (customerSearchForm) {
  // Redering the form
  document.querySelector("#searchCustomerBtn").addEventListener("click", function () {
    (0, _modal.showModal)("customerSearch");
  });
  customerSearchForm.addEventListener("submit", function (e) {
    e.preventDefault(); // Getting all the data

    var name = String(document.querySelector("#customerSearch-name").value).toLowerCase();
    var area = String(document.querySelector("#customerSearch-area").value).toLowerCase();
    var phoneNumber = Number(document.querySelector("#customerSearch-phoneNumber").value);
    var firmName = String(document.querySelector("#customerSearch-firmName").value);
    (0, _search.customerSearch)(name, area, phoneNumber, firmName);
  });
} // Adding a new entry
...
if (addEntryForm) {
  // Rendering the form
  document.querySelector(".allEntryAddBtn").addEventListener("click", function () {
    (0, _modal.showModal)("addEntry");
  }); // Disabling navbar links

  (0, _helperFunctions.disableLinks)(["addCustomerLink"]);
  addEntryForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var particulars = document.querySelector("#addEntry-particulars").value.trim();
    var date = document.querySelector("#addEntry-date").value;
    var debitAmount = document.querySelector("#addEntry-debitAmount").value.trim();
    var creditAmount = document.querySelector("#addEntry-creditAmount").value.trim();
    var images = document.querySelector("#addEntry-Image").files;
    ...
    if (!isNaN(debitAmount) && !isNaN(creditAmount)) {
      ...
      (0, _alerts.showAlert)("error", "Amount can only be a number", 3);
    }
  });
}
...
if (entrySearchForm) {
  ...
  if (window.location.search) document.querySelector(".allEntriesLink").classList.remove("hidden");
  document.querySelector(".allEntrySearchBtn").addEventListener("click", function () {
    (0, _modal.showModal)("entrySearch");
  });
  entrySearchForm.addEventListener("submit", function (e) {
    e.preventDefault(); // Getting all the data

    var particulars = document.querySelector("#searchEntry-particulars").value;
    var date = document.querySelector("#searchEntry-date").value;
    var debitAmount = document.querySelector("#searchEntry-debitAmount").value;
    var creditAmount = document.querySelector("#searchEntry-creditAmount").value; // Converting normal number to INR format to match it from the database

    if (debitAmount) {
      debitAmount = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "INR"
      }).format(debitAmount).split(".")[0];
    }
    ...
    if (creditAmount) {
      creditAmount = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "INR"
      }).format(creditAmount).split(".")[0];
    } // Sending data to ledgerSearch for further request


    (0, _search.ledgerSearch)(particulars, date, debitAmount, creditAmount);
  });
}

if (entryTableTr) {
  entryTableTr.forEach(function (entry) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              (0, _helperFunction.removeEntriesClasses)(entryTableTr);
              entry.classList.add("rowClicked"); // If user selects on cancel
              ...
              _context2.next = 7;
              return (0, _delete.deleteEntry)(entry.dataset.id);

            case 7:
              // If user selects for update entry
              if (e.target.closest(".updateEntryBtn")) {
                (0, _modal.showModal)("updateEntry");
                updateEntryForm = document.querySelector(".updateExistingEntryForm");
                updateEntryForm.addEventListener("submit",
                /*#__PURE__*/
                function () {
                  var _ref2 = _asyncToGenerator(
                  /*#__PURE__*/
                  _regeneratorRuntime().mark(function _callee(e) {
                    var particulars, date, creditAmount, debitAmount, documents, data, fields, i, currentCustomerId;
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) switch (_context.prev = _context.next) {
                        case 0:
                          e.preventDefault(); // Getting new data

                          particulars = document.querySelector("#updateExistingEntry-particulars");
                          date = document.querySelector("#updateExistingEntry-date");
                          creditAmount = document.querySelector("#updateExistingEntry-creditAmount");
                          debitAmount = document.querySelector("#updateExistingEntry-debitAmount");
                          documents = document.querySelector("#updateDocuments").files;

                          if (!(isNaN(Number(debitAmount.value)) || isNaN(Number(creditAmount.value)))) {
                            _context.next = 8;
                            break;
                          }

                          return _context.abrupt("return", (0, _alerts.showAlert)("error", "Amount can only be a number", 3));

                        case 8:
                          data = new FormData();
                          fields = [{
                            name: "particulars",
                            value: particulars.value.trim()
                          }, {
                            name: "date",
                            value: date.value.trim()
                          }, {
                            name: "debitBalance",
                            value: debitAmount.value.trim()
                          }, {
                            name: "creditBalance",
                            value: creditAmount.value.trim()
                          }];
                          ...
                          currentCustomerId = window.location.pathname.split("/")[2];
                          data.append("customer", currentCustomerId); // Calling updateEntry function with all the data

                          _context.next = 16;
                          return (0, _update.updateEntry)(data, entry.dataset.id);
              ...
              if (e.target.closest(".showPagesBtn")) {
                (0, _documents.showDocuments)(entry.dataset.id);
                (0, _helperFunction.removeEntriesClasses)(entryTableTr);
              }

              if (e.target.closest(".addPagesBtn")) {
                (0, _modal.showModal)("addDocs");
                addDocs.addEventListener("submit", function (e) {
                  e.preventDefault();
                  var images = document.querySelector("#addDocuments").files;
                  (0, _documents.addDocuments)(images, entry.dataset.id);
                });
              }
  ...
  document.addEventListener("click", function (e) {
    if (!e.target.closest(".entryTable")) (0, _helperFunction.removeEntriesClasses)(entryTableTr);
  });
}
},{"../../utils/helperFunction":"../../utils/helperFunction.js","./add":"add.js","./alerts":"alerts.js","./helperFunctions":"helperFunctions.js","./delete":"delete.js","./login":"login.js","./modal":"modal.js","./search":"search.js","./update":"update.js","./documents":"documents.js"}],"../../../../../../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
